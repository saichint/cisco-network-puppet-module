# Manages a Cisco PlbDeviceGroup.
#
# October 2016
#
...
Puppet::Type.newtype(:cisco_plb_device_group) do
  @doc = "Manages a Cisco PlbDeviceGroup.

  Any resource dependency should be run before the interface resource.

  cisco_plb_device_group {\"<name>\":
    ..attributes..
  }
  ...
  Example:
    cisco_plb_device_group {\"my_group\":
     ensure                       => present,
     probe_control                => false,
     probe_frequency              => 9,
     probe_port                   => 1000,
  ...
  newparam(:plbdg, namevar: :true) do
    desc "Name of the plb device group. Valid value is a string of
